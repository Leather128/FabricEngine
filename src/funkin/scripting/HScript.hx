...
class HScript extends Script {
	...
	public static var default_imports:haxe.ds.StringMap<Dynamic> = [
		...
		// PrintTypes //
		'LOG' => PrintType.LOG,
		'DEBUG' => PrintType.DEBUG,
		'WARNING' => PrintType.WARNING,
		'ERROR' => PrintType.ERROR,
		'SCRIPT' => PrintType.SCRIPT,
		// AssetTypes //
		'IMAGE' => base.assets.AssetType.IMAGE,
		'AUDIO' => base.assets.AssetType.AUDIO,
		'SPARROW' => base.assets.AssetType.SPARROW,
		...
		'Json' => tjson.TJSON,
		// HScript specific //
		'AssetType' => base.assets.AssetType,
	...
	public function new(path:String, call_new:Bool = true) {
		...
		if (funkin.scenes.Gameplay.instance != null)
			set_script_object(funkin.scenes.Gameplay.instance);
